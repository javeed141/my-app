  ...
  "paths": {
    "/ledger_account_balance_monitors": {
      "post": {
        ...
        "description": "",
        "operationId": "create-ledger-account-balance-monitor",
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                ...
                "properties": {
                  ...
                  "alert_condition": {
                    "type": "object",
                    "description": "The condition that must be satisfied for the monitor to be triggered.",
                    "required": [
                      "field",
                      "operator",
                      "value"
                    ...
                    "properties": {
                      ...
                      "value": {
                        "type": "integer",
                        "description": "The monitor will be triggered when comparing the `field` to this integer value with the `operator` is logically true.",
                        "format": "int32"
                      }
                    }
                  },
                  "metadata": {
                    "type": "string",
                    "description": "Metadata to be added to the ledger account balance monitor. Must be a JSON object.",
                    "format": "json"
                  }
                }
              }
