...
For a given page, see which viewers and how many times they visited, ordered by count.
...
```json
{
  ...
  "paths": {
    "/v2/pageview/{path}": {
      "get": {
        "description": "For a given page, see which viewers and how many times they visited, ordered by count.",
        "summary": "Get views by path",
        "operationId": "getPageViewsForPath",
        "tags": [
          "Page Views"
        ],
        "parameters": [
        ...
        "responses": {
          "200": {
            "description": "Page views broken down by user.",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
