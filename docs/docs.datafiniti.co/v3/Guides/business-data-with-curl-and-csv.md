...
[block:code]
{
  "codes": [
    {
      "code": "curl --user AAAXXXXXXXXXXXX: 'https://api.datafiniti.co/v3/data/businesses?view=businesses_all_nested&format=CSV&q=categories:hotels+AND+country:US&download=true'",
      "language": "curl"
    }
  ]
}
...
[block:code]
{
  "codes": [
    {
      "code": "curl 'http://datafiniti-downloads-qa.s3.amazonaws.com/AAAXXXXXXXXXXXX/6073_1.csv?AWSAccessKeyId=AKIAIXQMCWHOZB3O35SA&Signature=2YtBsW9xY8CZrWDECcdLzyx4Jlk%3D&Expires=1484754763' > output.csv",
      "language": "curl"
    }
  ]
}
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/eeb2bad-hotel_sample.jpg",
        "hotel_sample.jpg",
        1600,
        822,
        "#214768"
