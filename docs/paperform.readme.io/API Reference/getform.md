...
This endpoint returns a specific form by slug or ID. This feature is available as part of the [Standard API](https://paperform.co/pricing/).
  ...
  "paths": {
    "/forms/{slug_or_id}": {
      "get": {
        ...
        "description": "This endpoint returns a specific form by slug or ID. This feature is available as part of the [Standard API](https://paperform.co/pricing/).\n",
        "operationId": "getForm",
        "tags": [
          "Forms"
        ],
