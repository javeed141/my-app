...
Gets total unique page views for a project.
...
```json
{
  ...
  "paths": {
    "/v2/pageview/unique": {
      "get": {
        "description": "Gets total unique page views for a project.",
        "summary": "Get unique page views",
        "operationId": "getUniquePageViews",
        "tags": [
          "Page Views"
        ],
        "parameters": [
