...
Get count of page views per day for a particular date range.
...
```json
{
  ...
  "paths": {
    "/v2/pageview/views-per-day": {
      "get": {
        "description": "Get count of page views per day for a particular date range.",
        "summary": "Get page views per day",
        "operationId": "getPageViewsByDay",
        "tags": [
          "Page Views"
        ],
        "parameters": [
