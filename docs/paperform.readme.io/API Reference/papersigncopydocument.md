# /papersign/documents/{id}/copy

This endpoint copies a document.
  ...
  "paths": {
    "/papersign/documents/{id}/copy": {
      "post": {
        ...
        "description": "This endpoint copies a document.\nPlease note that this feature is exclusively available as part of the [Papersign API](https://paperform.co/products/papersign/#pricing).\n",
        "operationId": "papersignCopyDocument",
        "tags": [
          "Papersign Documents"
        ],
        "requestBody": {
        ...
        "responses": {
          "200": {
            "description": "Successfully copied a document\n",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
