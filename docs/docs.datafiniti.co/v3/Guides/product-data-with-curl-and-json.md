...
[block:code]
{
  "codes": [
    {
      "code": "curl --user AAAXXXXXXXXXXXX: 'https://api.datafiniti.co/v3/data/products?view=products_all&format=JSON&q=categories:shoes&records=1&download=false'",
      "language": "curl"
    }
  ]
}
...
[block:code]
{
  "codes": [
    {
      "code": "curl --user AAAXXXXXXXXXXXX: 'https://api.datafiniti.co/v3/data/products?view=products_all&format=JSON&q=categories:shoes+AND+-categories:shirts+AND+categories:women+AND+%28brand%3A%2A+OR+manufacturer%3A%2A%29+AND+prices%3A%2A&records=10&download=false'",
      "language": "curl"
    }
  ]
}
...
[block:code]
{
  "codes": [
    {
      "code": "curl --user AAAXXXXXXXXXXXX: 'https://api.datafiniti.co/v3/data/products?view=products_all&format=JSON&q=categories:shoes+AND+-categories:shirts+AND+categories:women+AND+%28brand%3A%2A+OR+manufacturer%3A%2A%29+AND+prices%3A%2A&download=true'",
      "language": "curl"
    }
  ]
}
