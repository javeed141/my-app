# Create Legal Entity Association
...
```json
{
  ...
  "paths": {
    "/legal_entity_associations": {
      "post": {
        "summary": "Create Legal Entity Association",
        "description": "",
        "operationId": "create-legal-entity-association",
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                ...
                "properties": {
                  "parent_legal_entity_id": {
                    "type": "string",
                    "description": "The ID of the parent legal entity. This must be a business legal entity."
                  },
                  "child_legal_entity_id": {
                    "type": "string",
                    "description": "The ID of the existing child legal entity. Note: Populate only one of `child_legal_entity` or `child_legal_entity_id`."
                  },
                  "child_legal_entity": {
                    "type": "object",
                    "description": "The child legal entity object. This will create a new Legal Entity. Note: Populate only one of `child_legal_entity` or `child_legal_entity_id`.",
                    "required": [
                      "legal_entity_type"
                    ],
                    "properties": {
                  ...
                  "relationship_types": {
                    "type": "array",
                    "description": "A list of relationship types for how the child entity relates to parent entity. One or more of: `beneficial_owner`, `control_person` or `authorized_signer`.",
                    "items": {
                      "type": "string"
                    }
                  },
