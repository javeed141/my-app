...
This endpoint updates a specific coupon by code.
  ...
  "paths": {
    "/forms/{slug_or_id}/coupons/{code}": {
      "put": {
        ...
        "description": "This endpoint updates a specific coupon by code.\nThis feature is available as part of the [Standard API](https://paperform.co/pricing/).\n",
        "operationId": "updateFormCoupon",
        "tags": [
          "Coupons"
        ],
        "requestBody": {
        ...
        "responses": {
          "200": {
            "description": "Successfully updated a single coupon with the provided values\n",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
