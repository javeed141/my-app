# /papersign/documents/{id}/cancel

This endpoint cancels a document. Document must be in progress to be cancelled.
  ...
  "paths": {
    "/papersign/documents/{id}/cancel": {
      "put": {
        ...
        "description": "This endpoint cancels a document. Document must be in progress to be cancelled.\nPlease note that this feature is exclusively available as part of the [Papersign API](https://paperform.co/products/papersign/#pricing).\n",
        "operationId": "papersignCancelDocument",
        "tags": [
          "Papersign Documents"
        ],
        "responses": {
          "200": {
            "description": "Successfully cancelled a document\n",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
