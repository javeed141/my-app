...
```json
{
  ...
  "paths": {
    "/v1/fraud/transactions/{transaction_token}": {
      "post": {
        "description": "Report fraud for a specific transaction token by providing details such as fraud type, fraud status, and any additional comments.\n",
    ...
    "schemas": {
      ...
      "fraud-report-request": {
        ...
        "properties": {
          ...
          "comment": {
            "type": "string",
            "description": "Optional field providing additional information or context about why the transaction is considered fraudulent."
          }
        },
        "required": [
          "fraud_status"
