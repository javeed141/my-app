...
Get the pages in your docs project with the highest number of negative votes.
...
```json
{
  ...
  "paths": {
    "/v2/thumb/worst": {
      "get": {
        "description": "Get the pages in your docs project with the highest number of negative votes.",
        "summary": "Get worst pages",
        "operationId": "getWorstPages",
        "tags": [
          "Page Quality"
        ],
        "parameters": [
        ...
        "responses": {
          "200": {
            "description": "Pages with the worst ratings.",
            "content": {
              "application/json": {
                "schema": {
                  "type": "array",
