...
```json
{
  ...
  "paths": {
    "/ledger_account_settlements/{id}/ledger_entries": {
      "patch": {
        "summary": "Add Ledger Entries to Settlement",
        "description": "This API allows attaching Ledger Entries to a `drafting` Ledger Account Settlement.",
        "operationId": "add-ledger-entries-to-settlement",
        "parameters": [
          {
            "name": "id",
            "in": "path",
          ...
          },
          {
            ...
            "in": "query",
            "description": "Array of ledger entry ids. The API supports a maximum of 500 ledger entry ids per request. You can pass them as query parameters delimited with ledger_entry_ids[]=, for example ?ledger_entry_ids[]=abc&ledger_entry_ids[]=cde or as request body param, for example { \"ledger_entry_ids\": [\"abc\",\"cde\"]}",
            "schema": {
              "type": "array",
              "items": {
                "type": "string"
            ...
            "application/json": {
              ...
              "examples": {
                "Request Example": {
                  "value": {
                    "ledger_entry_ids": [
                      "2a331970-7175-44d4-a537-07da9fcb024c",
                      "fd95cbf2-a3e8-43d9-b1b4-c2bbe2a593cc",
                      "0baa5574-11c8-46e2-9fd3-bc1265c72004"
                    ]
                  }
                }
              }
