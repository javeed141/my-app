# Get difference in page views

Get percent difference period-over-period of unique and total views for a project.
...
```json
{
  ...
  "paths": {
    "/v2/pageview/historical": {
      "get": {
        "description": "Get percent difference period-over-period of unique and total views for a project.",
        "summary": "Get difference in page views",
        "operationId": "getHistoricalPageViews",
        "tags": [
          "Page Views"
        ],
        "parameters": [
        ...
        "responses": {
          "200": {
            "description": "Percent difference in total calls and unique calls for a given period.",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
