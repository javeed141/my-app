  ...
  "paths": {
    "/forms/{slug_or_id}/partial-submissions/{id}": {
      "delete": {
        ...
        "description": "This endpoint deletes a specific partial submission by ID. This feature is available as part of the [Standard API](https://paperform.co/pricing/).\n",
        "operationId": "deleteFormPartialSubmission",
        "tags": [
          "Partial Submissions"
        ],
        "responses": {
          "200": {
            "description": "Successfully deleted a single partial submission that matched the provided ID\n",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
