...
Retrieve a breakdown of users who have searched for a particular term, include email and count.
...
```json
{
  ...
  "paths": {
    "/v2/search/{searchTerm}": {
      "get": {
        "description": "Retrieve a breakdown of users who have searched for a particular term, include email and count.",
        "summary": "Get data by search term",
        "operationId": "getUsersBySearchTerm",
        "tags": [
          "Search"
        ],
        "parameters": [
        ...
        "responses": {
          "200": {
            "description": "Search term breakdown per unique user.",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
