...
Get unique user email addresses with the most views for a project, sorted by total views per user.
...
```json
{
  ...
  "paths": {
    "/v2/pageview/users": {
      "get": {
        "description": "Get unique user email addresses with the most views for a project, sorted by total views per user.",
        "summary": "Get users",
        "operationId": "getPageViewsByUser",
        "tags": [
          "Page Views"
        ],
        "parameters": [
        ...
        "responses": {
          "200": {
            "description": "Top users by number of pages viewed and associated counts.",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
