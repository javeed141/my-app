...
This endpoint deletes a specific coupon by code.
  ...
  "paths": {
    "/forms/{slug_or_id}/coupons/{code}": {
      "delete": {
        ...
        "description": "This endpoint deletes a specific coupon by code.\nThis feature is available as part of the [Standard API](https://paperform.co/pricing/).\n",
        "operationId": "deleteFormCoupon",
        "tags": [
          "Coupons"
        ],
        "responses": {
          "200": {
            "description": "Successfully deleted a single coupon that matched the provided code\n",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
