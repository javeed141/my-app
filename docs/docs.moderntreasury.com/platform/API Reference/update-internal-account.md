...
> 📘 Partial Updates
>
> Only top-level fields that are included will be updated. If you wish to keep a value unchanged, simply omit the information from the body of your request.
>
> To reset a field, pass in a `null` value.
  ...
  "paths": {
    "/internal_accounts/{id}": {
      "patch": {
        ...
        "description": "",
        "operationId": "update-internal-account",
        "parameters": [
          {
            "name": "id",
            "in": "path",
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  "name": {
                    "type": "string",
                    "description": "A nickname for the internal account"
                  },
                  "metadata": {
                    "type": "string",
                  ...
                  "parent_account_id": {
                    "type": "string",
                    "description": "The UUID of the parent `InternalAccount` for this account. A null value will remove any existing association."
                  },
                  "counterparty_id": {
                    "type": "string",
                    "description": "The UUID of the [Counterparty](https://docs.moderntreasury.com/platform/reference/counterparty-object) this account refers to. A null value will remove any existing association."
                  },
                  "ledger_account_id": {
                    "type": "string",
                    "description": "The Ledger Account you would like to link to the internal account."
                  },
                  "contra_ledger_account_id": {
                    "type": "string",
                    "description": "The Contra Ledger Account you would like to link to the internal account."
                  }
                }
              }
            }
