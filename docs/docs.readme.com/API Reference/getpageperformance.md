...
Get votes and comments for a particular project page.
...
```json
{
  ...
  "paths": {
    "/v2/thumb/{path}": {
      "get": {
        "description": "Get votes and comments for a particular project page.",
        "summary": "Get page breakdown",
        ...
        "responses": {
          "200": {
            "description": "Breakdown of voting, comments, and company data.",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
