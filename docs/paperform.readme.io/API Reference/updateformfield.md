...
This endpoint updates a field on a form.
This feature is available as part of the [Standard API](https://paperform.co/pricing/).

**Please Note:** When updating a product field, product SKUs must be unique across the form, not just to the product field being updated.

### The following limits apply:

* **Choice** options are limited to 1000 per field.
* **Dropdown** options are limited to 1000 per field.
* **Products** are limited to 100 per form.
  ...
  "paths": {
    "/forms/{slug_or_id}/fields/{field_key}": {
      "put": {
        ...
        "description": "This endpoint updates a field on a form.\nThis feature is available as part of the [Standard API](https://paperform.co/pricing/).\n",
            ...
            "application/json": {
              ...
              "examples": {
                "update-dropdown-options": {
                  "summary": "Update the options for a Dropdown field",
                  "value": {
                    "dropdown": {
                      "options": [
                        "Option 1",
                ...
                "update-choices-options": {
                  "summary": "Update the options for a Choices field",
                  "value": {
                    "choices": {
                      "options": [
                        "Option 1",
                ...
                "update-scale-options": {
                  "summary": "Update the options for a Scale field",
                  "value": {
                    "scale": {
                      "options": [
                        "Option 1",
                ...
                "update-rank-options": {
                  "summary": "Update the options for a Rank field",
                  "value": {
                    "rank": {
                      "options": [
                        "Option 1",
                ...
                "update-calculations": {
                  "summary": "Update the calculation for a Calculations field",
                  "value": {
                    "calculations": {
                      "calculation": "1 + 2"
                    }
                ...
                "update-products": {
                  "summary": "Update the products for a Products field",
                  "value": {
                    "products": {
                      "products": [
                        {
        ...
        "responses": {
          "200": {
            "description": "Successfully updated a field with the provided values\n",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
