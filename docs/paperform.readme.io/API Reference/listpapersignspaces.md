  ...
  "paths": {
    "/papersign/spaces": {
      "get": {
        ...
        "description": "This endpoint returns a list of Papersign spaces.\nPlease note that this feature is exclusively available as part of the [Papersign API](https://paperform.co/products/papersign/#pricing).\n",
        "operationId": "listPapersignSpaces",
        "tags": [
          "Papersign Spaces"
        ],
        "requestBody": {
        ...
        "responses": {
          "200": {
            "description": "Successfully returned a list of Papersign spaces\n",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
