...
Get the pages in your docs project with the highest number of positive votes.
...
```json
{
  ...
  "paths": {
    "/v2/thumb/best": {
      "get": {
        "description": "Get the pages in your docs project with the highest number of positive votes.",
        "summary": "Get best pages",
        "operationId": "getBestPages",
        "tags": [
          "Page Quality"
        ],
        "parameters": [
        ...
        "responses": {
          "200": {
            "description": "Pages with the best ratings.",
            "content": {
              "application/json": {
                "schema": {
                  "type": "array",
