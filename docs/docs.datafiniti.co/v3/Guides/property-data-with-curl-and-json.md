# Property Data with cURL and JSON
...
[block:code]
{
  "codes": [
    {
      "code": "curl --user AAAXXXXXXXXXXXX: 'https://api.datafiniti.co/v3/data/properties?view=properties_all&format=JSON&q=country:US+AND+propertyType:\"Single+Family+Dwelling\"&download=true'",
      "language": "curl"
    }
  ]
}
...
[block:code]
{
  "codes": [
    {
      "code": "curl 'http://datafiniti-downloads.s3.amazonaws.com/AAAXXXXXXXXXXXX/6073_1.txt?AWSAccessKeyId=AKIAIXQMCWHOZB3O35SA&Signature=2YtBsW9xY8CZrWDECcdLzyx4Jlk%3D&Expires=1484754763' > output.txt",
      "language": "curl"
    }
  ]
}
