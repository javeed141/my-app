...
Retrieve top terms searched for in your project, and associated counts.
...
```json
{
  ...
  "paths": {
    "/v2/search/top-search-terms": {
      "get": {
        "description": "Retrieve top terms searched for in your project, and associated counts.",
