# Business Data with cURL and JSON
...
[block:code]
{
  "codes": [
    {
      "code": "curl --user AAAXXXXXXXXXXXX: 'https://api.datafiniti.co/v3/data/businesses?view=businesses_all&format=JSON&q=categories:hotels&records=1&download=false'",
      "language": "curl"
    }
  ]
}
...
[block:code]
{
  "codes": [
    {
      "code": "curl --user AAAXXXXXXXXXXXX: 'https://api.datafiniti.co/v3/data/businesses?view=businesses_all&format=JSON&q=categories:hotels+AND+country:US&records=10&download=false'",
      "language": "curl"
    }
  ]
}
...
[block:code]
{
  "codes": [
    {
      "code": "curl --user AAAXXXXXXXXXXXX: 'https://api.datafiniti.co/v3/data/businesses?view=businesses_all&format=JSON&q=categories:hotels+AND+country:US&download=true'",
      "language": "curl"
    }
  ]
}
...
[block:code]
{
  "codes": [
    {
      "code": "curl 'http://datafiniti-downloads-qa.s3.amazonaws.com/AAAXXXXXXXXXXXX/6073_1.txt?AWSAccessKeyId=AKIAIXQMCWHOZB3O35SA&Signature=2YtBsW9xY8CZrWDECcdLzyx4Jlk%3D&Expires=1484754763' > output.csv",
      "language": "curl"
    }
  ]
}
...
From here, you'll most likely want to process the data using the programming language of your choice. Our other [JSON guides](https://docs.datafiniti.co/docs/getting-started-with-business-data) provide instructions on how to process this data.