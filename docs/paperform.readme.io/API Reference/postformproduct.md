...
This endpoint creates a product on a form. Please note that this feature is exclusively available as part of the [Business API](https://paperform.co/pricing/).
  ...
  "paths": {
    "/forms/{slug_or_id}/products": {
      "post": {
        ...
        "description": "This endpoint creates a product on a form. Please note that this feature is exclusively available as part of the [Business API](https://paperform.co/pricing/).\n",
        "operationId": "postFormProduct",
        "tags": [
          "Products"
        ],
        "requestBody": {
