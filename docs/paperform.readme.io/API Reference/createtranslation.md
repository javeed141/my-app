...
This endpoint creates a translation.
...
```json
{
  ...
  "paths": {
    "/translations": {
      "post": {
        "description": "This endpoint creates a translation.\nPlease note that this feature is exclusively available as part of the [Business API](https://paperform.co/pricing/).\n",
        ...
        "responses": {
          "200": {
            "description": "Successfully created a translation with the provided values\n",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
