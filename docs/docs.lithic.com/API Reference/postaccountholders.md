      ...
      "Kyb": {
        "properties": {
          ...
          "kyb_passed_timestamp": {
            "description": "An RFC 3339 timestamp indicating when precomputed KYB was completed on the business with a pass result.\n\nThis field is required only if workflow type is `KYB_BYO`.\n",
