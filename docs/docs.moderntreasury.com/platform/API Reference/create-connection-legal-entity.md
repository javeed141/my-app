...
```json
{
  ...
  "paths": {
    "/connection_legal_entities": {
      "post": {
        "summary": "Create Connection Legal Entity",
        "description": "**Note: This is not supported in our sandbox environment**",
        "operationId": "create-connection-legal-entity",
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                ...
                "properties": {
                  ...
                  "legal_entity_id": {
                    "type": "string",
                    "description": "The ID of the legal entity. Please provide this value or `legal_entity`."
                  },
                  "legal_entity": {
                    "type": "object",
                    "description": "The legal entity. Please provide this value or `legal_entity_id`.",
                    "required": [
                      "legal_entity_type"
                    ],
                    "properties": {
