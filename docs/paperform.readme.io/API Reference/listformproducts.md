...
This endpoint returns the list of products available for a specific form by slug or ID. This feature is available as part of the [Standard API](https://paperform.co/pricing/).
  ...
  "paths": {
    "/forms/{slug_or_id}/products": {
      "get": {
        ...
        "description": "This endpoint returns the list of products available for a specific form by slug or ID. This feature is available as part of the [Standard API](https://paperform.co/pricing/).\n",
        "operationId": "listFormProducts",
        "tags": [
          "Products"
        ],
        "responses": {
